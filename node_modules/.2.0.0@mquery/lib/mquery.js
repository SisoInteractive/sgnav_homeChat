 ...
 *     UserModel.where('age').gte(21).lte(65);
 *
 *     // passing query conditions is permitted
 *     UserModel.find().where({ name: 'vonderful' })
 *
 *     // chaining
 *     UserModel
 ...
 * ####Example
 *
 *     UserModel.where('age').equals(49);
 *
 *     // is the same as
 *
 *     UserModel.where('age', 49);
 *
 * @param {Object} val
 * @return {Query} this
 * @api public
 ...
 * ####Example
 *
 *     UserModel.where('age').eq(49);
 *
 *     // is the same as
 *
 *     UserModel.shere('age').equals(49);
 *
 *     // is the same as
 *
 *     UserModel.where('age', 49);
