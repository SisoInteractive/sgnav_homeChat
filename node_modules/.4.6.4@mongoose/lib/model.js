 ...
 *
 *     UserModel.find({age: {$gte: 21, $lte: 65}}, callback);
 *
 * we can instead write:
 *
 *     UserModel.where('age').gte(21).lte(65).exec(callback);
 *
 ...
 *     o.verbose = true;
 *
 *     UserModel.mapReduce(o, function (err, model, stats) {
 ...
 *     var promise = UserModel.mapReduce(o);
 ...
 *     UserModel.find(match, function (err, users) {
 *       var opts = [{ path: 'company', match: { x: 1 }, select: 'name' }]
 *
 *       var promise = UserModel.populate(users, opts);
